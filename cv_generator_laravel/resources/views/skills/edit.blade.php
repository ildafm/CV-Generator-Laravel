...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Updating your {{ $skillUser->skill_name }} skill</h5>
            ...
            <form action="{{ route('skills.update', ['skill' => $skillUser->id]) }}" method="POST"
                ...
                <div class="form-group mb-2">
                    ...
                    <input name="skill_name" type="text" class="form-control @error('skill_name') is-invalid @enderror"
                        ...
                        value="{{ old('skill_name', $skillUser->skill_name) }}" required>
                    @error('skill_name')
                ...
                <div class="form-group mb-2">
                    ...
                    <div style="display: flex; align-items: center;">
                        <input name="skill_confident" type="range" class="custom_range" min="1" max="100"
                            step="1" value="{{ old('skill_confident', $skillUser->skill_confident) }}"
                            id="skill_confident">
                        <output for="skill_confident" id="output_skill_confident">{{ $skillUser->skill_confident }}</output>
                    </div>
